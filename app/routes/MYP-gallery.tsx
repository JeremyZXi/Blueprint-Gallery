import MYPGallery from "../components/MYPGallery";
...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "MYP Design Gallery | Blueprint Gallery" },
    { name: "description", content: "Browse innovative MYP design projects" },
  ];
}

export default function MYPGalleryPage() {
  return (
